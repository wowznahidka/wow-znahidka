    ...
    <div class="pd-info">
      ...
      <p class="pd-lead">
        ${product.isFreeShipping
          ? `<b>Доставка коштом нашим.</b> На пошті 200₴ застави — приміряй, не підійшло, забирай гроші назад.`
          : `<b>Без передоплати.</b> На пошті 200₴ застави — приміряй, не підійшло, забирай гроші назад. Без "ой почекайте 3 дні".`}
      </p>
      ${sizeChips}
      <div class="pd-trust">
